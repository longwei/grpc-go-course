...
type SqrtRequest struct {
	...
	Number int32 `protobuf:"varint,1,opt,name=number,proto3" json:"number,omitempty"` //should be uint32
}
...
var file_sqrt_proto_rawDesc = []byte{
	...
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6c, 0x6f, 0x6e, 0x67, 0x77, 0x65, 0x69, 0x2f, 0x67, 0x72,
